...
$string['context_type_customprompt'] = 'Mensaje personalizado';
...
$string['custom_prompt_field'] = 'Mensaje para la IA';
$string['custom_prompt_field_help'] = 'Describe el contexto del curso que quieres que la IA utilice. Puedes usar formato y contenido multimedia para enriquecer las instrucciones.';
...
$string['error_context_type_required'] = 'Selecciona un tipo de contexto para continuar (Programa o Mensaje personalizado).';
...
$string['error_prompt_required'] = 'Debes proporcionar un mensaje cuando el tipo de contexto es "Mensaje personalizado".';
...
$string['error_syllabus_pdf_required'] = 'Debes subir un archivo PDF del programa cuando el tipo de contexto es "Programa".';
...
$string['error_upload_failed'] = 'Error al subir el programa: {$a}';
...
$string['privacy:metadata:local_coursegen_course_context:prompt_text'] = 'El texto del mensaje personalizado proporcionado para el curso.';
...
$string['syllabus_pdf_field_help'] = 'Sube un archivo PDF que contenga el programa del curso. Se enviará a la IA para el análisis de contexto. Tamaño máximo del archivo: 10 MB.';
...
$string['use_system_instruction_field_help'] = 'Activa esta opción cuando quieras complementar el contexto seleccionado (mensaje o programa) con una instrucción del sistema reutilizable. Las instrucciones del sistema definen reglas globales que la IA debe seguir siempre al generar contenido del curso.';
