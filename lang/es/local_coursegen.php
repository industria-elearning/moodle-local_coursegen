...
$string['use_system_instruction_field_help'] = 'Activa esta opción cuando quieras complementar el contexto seleccionado (prompt o sílabus) con una instrucción del sistema reutilizable. Las instrucciones del sistema definen reglas globales que la IA debe respetar siempre al generar contenido del curso.';
