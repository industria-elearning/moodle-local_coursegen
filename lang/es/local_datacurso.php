...
$string['error_saving_session'] = 'No se pudo guardar la sesión de planificación. Por favor, inténtalo nuevamente.';
$string['error_sending_message'] = 'Error al enviar el mensaje';
$string['error_starting_course_planning'] = 'Ocurrió un error al iniciar la sesión de planificación del curso. Por favor, inténtalo nuevamente.';
...
$string['syllabus_pdf_field_help'] = 'Sube un archivo PDF que contenga el programa del curso. Será enviado a la IA para análisis contextual. Tamaño máximo: 10 MB.';
