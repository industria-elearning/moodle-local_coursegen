...
$string['tutoraiapiurl'] = 'Tutor-IA API URL';
$string['tutoraiapiurl_desc'] = 'Base URL for the Tutor-IA API (e.g., https://plugins-ai-dev.datacurso.com)';
$string['tutoraitoken'] = 'Tutor-IA Token';
$string['tutoraitoken_desc'] = 'Authentication token for the Tutor-IA API';
$string['enablechat'] = 'Enable Chat';
$string['enablechat_desc'] = 'Enable or disable the Tutor-IA chat globally';
$string['sessionnotready'] = 'The Tutor-IA session is not ready. Please try again.';
