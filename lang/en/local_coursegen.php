...
$string['error_starting_course_planning'] = 'There was an error starting the course planning session: {$a}';
$string['error_context_type_required'] = 'Please select a context type to continue (Instructional model or Syllabus).';
