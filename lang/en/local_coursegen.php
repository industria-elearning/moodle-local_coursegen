...
$string['ai_response_language_help'] = 'Select the language in which the AI will respond and generate the course content.';
...
$string['course_generate_images_field'] = 'Images for the course';
$string['course_generate_images_field_help'] = 'Choose whether the AI should generate images when creating the course (for sections, activities, and other visual elements).';
...
$string['use_system_instruction_field'] = 'Use system instruction';
