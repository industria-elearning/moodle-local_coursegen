...
$string['custom_prompt_field_help'] = 'Descreva o contexto do curso que você deseja que a IA use. Você pode usar formatação e mídia para enriquecer as instruções.';
