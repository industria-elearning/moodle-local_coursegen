...
$string['addactivityai_done'] = 'Concluído! O recurso ou atividade foi criado.';
...
$string['addactivityai_welcome'] = 'Olá! Diga-me qual recurso ou atividade você precisa e eu o criarei em seu curso. 😊';
...
$string['adjust_planning_title'] = 'Ajustar planejamento do curso';
$string['click_to_view_details'] = 'Clique para ver detalhes';
$string['confirmdelete'] = 'Tem certeza de que deseja excluir este modelo?';
$string['context_type_field'] = 'Tipo de contexto';
$string['context_type_model'] = 'Modelo instrucional';
$string['context_type_syllabus'] = 'Programa';
...
$string['course_streaming_planning_title'] = 'Planejamento da criação do curso';
$string['coursecreated'] = 'Curso criado com sucesso';
$string['coursegen:managemodels'] = 'Gerenciar modelos';
$string['coursegen:view_syllabus'] = 'Ver programa';
$string['createwithai'] = 'Criar com IA';
$string['creating_course'] = 'Criando curso...';
$string['custom_model_select_field'] = 'Escolha o modelo a usar';
$string['delete'] = 'Excluir';
$string['deletemodel'] = 'Excluir modelo';
$string['edit'] = 'Editar';
...
$string['error_starting_course_planning'] = 'Ocorreu um erro ao iniciar a sessão de planejamento do curso. Tente novamente.';
$string['error_upload_failed'] = 'Falha ao enviar o programa: {$a}';
$string['error_upload_failed_model'] = 'Falha ao enviar o modelo: {$a}';
...
$string['managemodels'] = 'Gerenciar modelos';
$string['message_sent_successfully'] = 'Mensagem enviada com sucesso para a sessão de planejamento com IA.';
$string['modelcontent'] = 'Conteúdo do modelo';
$string['modelcontent_help'] = 'Forneça a descrição completa do modelo instrucional, incluindo suas fases/etapas, finalidade e como ele deve orientar o design do curso.';
$string['modelcreated'] = 'Criado';
$string['modeldeleted'] = 'Modelo excluído com sucesso';
$string['modelmodified'] = 'Modificado';
$string['modelname'] = 'Nome do modelo';
$string['modelname_help'] = 'Insira o nome do modelo instrucional que você utilizará para o design do curso. Por exemplo: ADDIE, Gagné, ou outro framework reconhecido.';
$string['modelnameexists'] = 'Já existe um modelo com este nome';
...
$string['module_streaming_parameters_start'] = '🔧 Aplicando configuração da atividade...';
$string['module_streaming_schema_done'] = '✅ Estrutura de conteúdo pronta';
$string['module_streaming_schema_start'] = '📋 Criando estrutura de conteúdo...';
$string['module_streaming_start'] = '🚀 Iniciando criação da atividade...';
$string['noimages'] = 'Não gerar imagens';
$string['nomodels'] = 'Nenhum modelo encontrado';
...
$string['pluginname'] = 'Criador de Curso IA';
$string['privacy:metadata:local_coursegen'] = 'Course Creator AI armazena dados pessoais para dar suporte à geração de cursos e módulos com IA.';
...
$string['privacy:metadata:local_coursegen_course_context:model_id'] = 'O ID do modelo instrucional selecionado para o curso.';
$string['privacy:metadata:local_coursegen_course_context:timecreated'] = 'A data de criação do registro de contexto do curso.';
$string['privacy:metadata:local_coursegen_course_context:timemodified'] = 'A data da última atualização do registro de contexto do curso.';
...
$string['privacy:metadata:local_coursegen_course_sessions:timecreated'] = 'A data de criação da sessão de planejamento do curso.';
$string['privacy:metadata:local_coursegen_course_sessions:timemodified'] = 'A data da última atualização da sessão de planejamento do curso.';
...
$string['privacy:metadata:local_coursegen_model'] = 'Modelos instrucionais criados ou editados para a geração de cursos.';
$string['privacy:metadata:local_coursegen_model:content'] = 'A descrição armazenada do modelo instrucional.';
$string['privacy:metadata:local_coursegen_model:deleted'] = 'Se o modelo instrucional está marcado como excluído.';
$string['privacy:metadata:local_coursegen_model:name'] = 'O nome do modelo instrucional.';
$string['privacy:metadata:local_coursegen_model:timecreated'] = 'A data de criação do modelo instrucional.';
$string['privacy:metadata:local_coursegen_model:timemodified'] = 'A data da última atualização do modelo instrucional.';
$string['privacy:metadata:local_coursegen_model:usermodified'] = 'O ID do usuário que modificou o modelo instrucional pela última vez.';
$string['privacy:metadata:local_coursegen_module_jobs'] = 'Detalhes de trabalhos de geração de módulos com IA enfileirados pelos usuários.';
...
$string['privacy:metadata:local_coursegen_module_jobs:generate_images'] = 'Se o trabalho de módulo irá gerar imagens.';
...
$string['privacy:metadata:local_coursegen_module_jobs:model_name'] = 'O nome do modelo instrucional fornecido ao serviço de IA.';
...
$string['privacy:metadata:local_coursegen_module_jobs:timecreated'] = 'A data de criação do trabalho de módulo.';
$string['privacy:metadata:local_coursegen_module_jobs:timemodified'] = 'A data da última atualização do trabalho de módulo.';
...
$string['send'] = 'Enviar';
$string['syllabus_pdf_field'] = 'Enviar PDF do programa';
$string['syllabus_pdf_field_help'] = 'Envie um arquivo PDF contendo o programa do curso. Ele será enviado à IA para análise contextual. Tamanho máximo: 10 MB.';
