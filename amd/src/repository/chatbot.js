 ...
 *
 * @module     aiplacement_coursegen/repository/chatbot
...
export async function planCourseMessage({courseid, text}) {
    ...
    return ajax.call([
        {
            methodname: "aiplacement_coursegen_plan_course_message",
            args,
        },
    ])[0];
}
...
export async function createMod({courseid, sectionnum, beforemod, jobid}) {
    ...
    return ajax.call([
        {
            methodname: "aiplacement_coursegen_create_mod",
            args,
        },
    ])[0];
}
...
export async function createModStream({courseid, sectionnum, beforemod, prompt, generateimages}) {
    ...
    return ajax.call([
        {
            methodname: "aiplacement_coursegen_create_mod_stream",
            args,
        },
    ])[0];
}
...
export async function createCourse({courseid}) {
    ...
    return ajax.call([
        {
            methodname: "aiplacement_coursegen_create_course",
            args,
        },
    ])[0];
}
...
export async function planCourseExecute(courseid) {
    return ajax.call([
        {
            methodname: "aiplacement_coursegen_plan_course_execute",
