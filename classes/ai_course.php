...
class ai_course {
    ...
    public static function start_course_planning($courseid, $contexttype, $modelname, $coursename) {
        ...
        try {
            ...
            if (!isset($result['session_id'])) {
                return [
                    'ok' => false,
                    'message' => get_string('error_starting_course_planning', 'aiplacement_coursegen'),
            ...
            if (!$success) {
                return [
                    'ok' => false,
                    'message' => get_string('error_saving_session', 'aiplacement_coursegen'),
            ...
            return [
                ...
                'message' => get_string('course_planning_started', 'aiplacement_coursegen'),
            ];
        } catch (\Exception $e) {
    ...
    public static function save_course_session($courseid, $sessionid) {
        ...
        try {
            ...
            $existingsession = $DB->get_record('aiplacement_coursegen_course_sessions', ['courseid' => $courseid]);
            ...
            if ($existingsession) {
                ...
                return $DB->update_record('aiplacement_coursegen_course_sessions', $sessiondata);
            } else {
                // Create new session record.
                $sessiondata->timecreated = time();
                return $DB->insert_record('aiplacement_coursegen_course_sessions', $sessiondata);
            }
        } catch (\Exception $e) {
    ...
    public static function get_course_session($courseid) {
        ...
        try {
            return $DB->get_record('aiplacement_coursegen_course_sessions', ['courseid' => $courseid]);
        } catch (\Exception $e) {
    ...
    public static function update_session_status($courseid, $status) {
        ...
        try {
            ...
            return $DB->update_record('aiplacement_coursegen_course_sessions', $session);
        } catch (\Exception $e) {
